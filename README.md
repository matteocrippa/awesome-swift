...
* [SwiftGuide CN](https://github.com/ipader/awesome-swift) - A Chinese written guide.
...
* [YMCache](https://github.com/yahoo/YMCache) - Simple blazing fast key-value store, designed to power realtime market feed for Yahoo Finance app.
...
* [SwiftFFmpeg](https://github.com/sunlubo/SwiftFFmpeg) - A Swift wrapper for the FFmpeg C API.
