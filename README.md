...
* [SugarRecord](https://github.com/gitdoapp/SugarRecord) - an easy with to work with coredata and realm.
...
* [SDWebImage] (https://github.com/rs/SDWebImage) - provides a category for UIImageView with support for remote images coming from the web. (Animated Gif Support)
...
* [TVButton](https://github.com/marmelroy/TVButton) - Simple but highly customizable iOS tag list view.
